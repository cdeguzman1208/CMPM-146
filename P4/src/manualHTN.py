...
pyhop.declare_operators (op_punch_for_wood, op_craft_wooden_axe_at_bench, op_craft_wooden_pickaxe_at_bench, op_craft_plank, op_craft_bench, op_craft_stick, op_get_wood_with_wooden_axe)
...
def produce (state, ID, item):
	...
	# your code here
		...
		# this check to make sure we're not making multiple pickaxes
